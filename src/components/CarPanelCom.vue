        ...
        <div v-else class="full">
                    ...
                    <div class="item-desc">
                      <div class="cart-cell">
                        ...
                        <h6>
                          ...
                          <span class="price-num">{{item.goods_price}}</span>
                          <span class="item-num">x {{item.count}}</span>
                        </h6>
                      </div>
                    </div>
                    <div @click="delCarPanelHandle(item.goods_id)" class="del-btn">删除</div>
                  </div>
                </div>
              </li>
            </ul>
          ...
          <div class="nav-cart-total">
            ...
            <h5>
              合计：
              <span class="price-icon">¥</span>
              <span class="price-num">{{totle}}</span>
            </h5>
            <h6>
